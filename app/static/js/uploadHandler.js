...
async function handleFileSelect() {
    ...
    try {
        ...
        if (extension === 'epub') {
            ...
            pageCount = extension === 'docx' ? processor.getPageCount() : null;
        ...
        const extraMeta = { fileType: extension };
        if (pageCount) extraMeta.pageCount = pageCount;
        const bookIdFromDB = await addBook(title, file, bookId, extraMeta);
