...
try:
    ...
    class CORS:
        """Minimal stub used during testing when flask_cors isn't installed."""

        def __init__(self, app=None, **_kwargs):
            if app:
                self.init_app(app, **_kwargs)

        def init_app(self, app, **_kwargs):
            if hasattr(app, "logger"):
                app.logger.debug("CORS stub active")
