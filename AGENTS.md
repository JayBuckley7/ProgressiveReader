...
- If JavaScript tests are added in the future, run `npm test` as well. When editing the TypeScript React frontend, run `npm run lint && npm run format` before committing.
