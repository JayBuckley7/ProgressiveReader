...
- **File Upload**: Upload `.epub`, `.txt`, or `.docx` files via a web form. DOCX uploads preserve reported page counts if present.
...
3.  Click "Upload File". For DOCX files, the reader stores the original page count when available.
