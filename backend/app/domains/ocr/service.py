...
class OCRService:
    ...
    def __init__(self):
        ...
        # Credentials are stored in GOOGLE_APPLICATION_CREDENTIALS_JSON env var as JSON string
        try:
            ...
            if creds_json_str:
                ...
                # Fallback to Application Default Credentials if env var not set (for local dev)
