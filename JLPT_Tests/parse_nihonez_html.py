...
def parse_question(
    ...
    *,
    ...
    prompt = first_text(container, ".question .question-content")
    choices = [html_to_text(choice.select_one(".choice-text-furigana") or choice) for choice in container.select("label.answer-choice")]
