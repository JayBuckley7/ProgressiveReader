    ...
    <div className="container mx-auto px-4 py-8">
      ...
      {!isAuthenticated ? (
        ...
        <div className="text-center py-16">
          ...
          <p className="text-gray-500 dark:text-gray-400 mb-6">
            Connect to Google Drive to access your book library stored in the cloud.
          </p>
          <button
            onClick={connectToGoogleDriveAndLoad}
            disabled={isLoading || isDriveBookLoading}
